...
export default class App extends Component {
  ...
  constructor(props){
    super(props);
    const rand = Math.floor(Math.random()*pokedex.length) - 1;
    this.state = {
      pokemon : [pokedex[rand].name, pokedex[rand].id, pokedex[rand].type],
      pokemons : pokedex
    } 
  ...
  render() {
    /* AREA DE TRABAJO
    Pueden usar desestructuracion o directamente modificar las variables this.state.pokemon por this.state...
    */

    return (
      <div style={{display:"flex"}}>
      <div className="container nes-container" >
